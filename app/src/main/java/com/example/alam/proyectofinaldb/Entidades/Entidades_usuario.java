...
public class Entidades_usuario {
    ...
    public Entidades_usuario(int usuarios_id, String usuarios_nombre, String usuarios_correo, Date usuarios_fechaNacimiento, String usuarios_contraseña, int usuarios_saldo) {
